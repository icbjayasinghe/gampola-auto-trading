            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="<?php echo base_url('index.php/Home/view_supplier');?>"><i class="fa fa-users"></i> View Suppliers</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
...
<script>
    function viewbtn(element) {
        $.ajax({
            type:"POST",
            data:{ch_number:element.parentElement.parentElement.getElementsByTagName('td')[7].innerHTML},
