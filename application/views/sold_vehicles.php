            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="<?php echo base_url('index.php/Home/sold');?>"><i class="fa fa-circle-o"></i> Sold</a></li>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Sold Vehicle</h3>
                                    ...
                                    if($request->num_rows()>0){
                                        foreach ($request->result() as $row){
                                            ...
                                            <tr>
                                                ...
                                                <td><button class="btn btn-success btn-sm" onclick="viewbtn(this)" data-toggle="modal" data-target="#mymodal"><span class="glyphicon glyphicon-eye-open"></span> View</button></td>
                                                <td><button class="btn btn-warning btn-sm" onclick="buyer_viewbtn(this)" data-toggle="modal" data-target="#mymodal2"><span class="glyphicon glyphicon-eye-open"></span> View</button></td>
...
<script>
    ...
    function buyer_viewbtn(element) {
        //alert("asda");
        $.ajax({
            type:"POST",
            data:{ch_number:element.parentElement.parentElement.getElementsByTagName('td')[4].innerHTML},
            ...
            cache: false,
            success:function (data) {
                $('#name_modal2').val(data.buy_name);
                $('#nic_modal2').val(data.buy_nic);
                $('#phone2').val(data.buy_tel);
                $('#address2').val(data.buy_address);
                $('#leasing').val(data.leasing);
                $('#installments').val(data.installment);
                $('#amount').val(data.amount);
                $('#insurance').val(data.insurance);
                $('#description').val(data.buy_discription);
                $('#date').val(data.buy_date);
            ...
            <div class="modal-body">
                <form method="post" id="insert_form">
                    <div class="form-group row row ">
                        <label for="example-text-input" class="col-md-3 col-form-label clearfix">Name</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text" name="name_modal2" id="name_modal2" disabled="disabled" maxlength="50" required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group row col-md-6">
                        <label for="example-text-input" class="col-md-4 col-form-label clearfix">NIC</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text" name="nic_modal2" id="nic_modal2" disabled="disabled" maxlength="50" required="">
                        </div>
                    </div>
                    ...
                    <div class="form-group row row col-md-6">
                        <label for="example-text-input" class="col-md-4 col-form-label clearfix">Contact Number</label>
                        <div class="col-md-8">
                            <input class="form-control" type="number" name="phone2" id="phone2" maxlength="50" disabled="disabled" required="">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="example-email-input" class="col-md-3 col-form-label">Address</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text"  id="address2" name="address2" disabled="disabled" maxlength="50" required="">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="example-email-input" class="col-md-3 col-form-label">Leasing Company</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text"  id="leasing" name="leasing" disabled="disabled" maxlength="50" required="">
                        </div>
                    </div>

                    <div class="form-group row col-md-6">
                        <label for="example-email-input" class="col-md-4 col-form-label">Installments</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text"  id="installments" name="installments" disabled="disabled" maxlength="50" required="">
                        </div>
                    </div>

                    <div class="form-group row col-md-6">
                        <label for="example-email-input" class="col-md-4 col-form-label">Amount</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text"  id="amount" name="amount" disabled="disabled" maxlength="50" required="">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="example-email-input" class="col-md-3 col-form-label">Insurance</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text"  id="insurance" name="insurance" disabled="disabled" maxlength="50" required="">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="example-email-input" class="col-md-3 col-form-label">Description</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text"  id="description" name="description" disabled="disabled" maxlength="50" required="">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="example-email-input" class="col-md-3 col-form-label">Date</label>
                        <div class="col-md-8">
                            <input class="form-control" type="text"  id="date" name="date" disabled="disabled" maxlength="50" required="">
                        </div>
                    </div>
